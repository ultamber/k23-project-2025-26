...
def main():
    ...
    parser.add_argument("--knn-graph-file",type=str, default="", help="Precomputed k-NN graph file")
    parser.add_argument("--calculated-output", default="../groundtruth.csv", help="Precomputed Project1 output file")
